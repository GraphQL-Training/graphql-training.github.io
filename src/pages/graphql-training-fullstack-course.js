...
const Index = () => (
  <div>
    ...
    <PageHeaderPage
      title={
        <div>
          GraphQL for Fullstack<br /> Developers & Teams
        </div>
      }
    />
        ...
        <div className="col-xs-12">
          <div className="flex flex-column items-center">
            ...
            <p>
              ...
              mutations and fragments, the course progresses to building skills
              in areas such as schema design, authentication and API
              performance.
            </p>
      ...
      <div className="container mw8">
        ...
        <div className="row bg-white">
          <SplitColumn>
            ...
            <ul>
              ...
              <li>
                ...
                teams, API performance, maintainability, and preventing bugs and
                regressions?
              </li>
            </ul>
          ...
          <SplitColumn>
            ...
            <ul>
              <li>Client-side caches, synchronisation, global identifiers.</li>
              <li>
        ...
        <div className="col-xs-12">
          <div className="flex flex-column items-center">
            ...
            <p>
              ...
              understanding of modern JavaScript (ES2017) will be very helpful.
              If you prefer another environment, you should come to Day 2 with
              your favourite stack and GraphQL libraries pre-installed. Those
              attendees wishing to follow along with the JS code examples should
              have Node.js v8.6 or higher with the accompanying npm installed.{" "}
            </p>
          </div>
        </div>
      </div>
