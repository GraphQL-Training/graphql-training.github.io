        ...
        <div className="col-xs-12">
          <div className="flex flex-column items-center">
            <h3 className="divider-center">
              2 Day GraphQL course for<br />frontend engineers
            </h3>
            <p>
            ...
            <p className="">
              ...
              intuitions to create GraphQL applications rapidly and on the right
              footing. Starting with learning the core concepts and how to use
              queries, mutations and fragments, the course progresses to
              building advanced skills in areas such as authentication, caching,
              optimistic updates and debugging.
            </p>
            ...
            <ul>
              ...
              <li>
                Developers who’ve recently started with GraphQL and are looking
                to build a more solid understanding.
              </li>
              <li>
      ...
      <div className="row">
        <div className="col-xs-12">
          <div className="flex flex-column items-center">
            ...
            <p>
              All attendees must bring a laptop with git, the latest version of
              Google Chrome, the React Developer Tools Chrome extension, and
              Node v8.6 or higher with the associated npm installed.{" "}
            </p>
            <p className="">
              ...
              particularly concepts like state management, lifecycle methods and
              higher order components - is advised. We’re happy to send primers
              for those not yet comfortable with these technologies.{" "}
            </p>
          </div>
        </div>
      </div>
